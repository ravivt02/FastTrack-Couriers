    ...
    <form action="courierMenu.php" method="POST" enctype="multipart/form-data">
        <div style="overflow-x:auto;">
            <table border="0px solid" style="margin: auto; font-weight:bold;border-spacing: 5px 15px;">
                <th colspan="4" style="text-align: center;background-color:#ced5d2; width: 140px; height: 50px;">Fill The Details Of Sender & Receiver</th>
                <tr>
                ...
                <tr>
                    <td colspan="4" align="center"><input type="submit" name="submit" value="Place Order" style="background-color: #007fff; border-radius: 50px; width: 140px; height: 50px;cursor:pointer; border: none; font-size: 20px;"></td>
                </tr>
            </table>
        </div>
    </form>
