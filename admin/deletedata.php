...
<div class="admintitle">
    <div>
    <h5 ><a href="dashboard.php" style="float: left; margin-left:20px; color:black;">BackToDashboard</a></h5>
    <h5 ><a href="logout.php" style="float: right; margin-right:20px; color:black;">LogOut</a></h5>
    </div>
    <h1 align='center' style="color:black">Search Data Information</h1>
</div>

<div style="overflow-x:auto;">
<table width='80%' border="1px solid" style="margin-left: auto; margin-right:auto; margin-top:30px; font-weight:bold;border-spacing: 1px 1px;">
    <tr style="background-color: #c5c6c3;">
        <th>No.</th>
        <th>Items Image</th>
        <th>Sender Name</th>
        <th>Receiver Name</th>
